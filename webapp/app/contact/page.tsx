...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const runInlineScripts = () => {
      const scriptContents: string[] = ["\nfunction sendContact(){\n  var n=document.getElementById('cName').value.trim();\n  var e=document.getElementById('cEmail').value.trim();\n  var m=document.getElementById('cMsg').value.trim();\n  if(!n||e.indexOf('@')<0||!m){alert('Please fill in your name, a valid email and a message.');return;}\n  window.location.href='mailto:support@scalewin.ai?subject='+encodeURIComponent('Contact from '+n)+'&body='+encodeURIComponent(m+'\\n\\nFrom: '+n+' ('+e+')');\n}\n"];
...
<div class="wrap"><header class="legal-head"><h1>Contact Us</h1><div class="upd">Last updated: 16 June 2026</div></header></div>
<main class="legal">
<p style="text-align:center;max-width:560px;margin:0 auto 8px;color:var(--ink-soft)">Have a question about ScaleWin, billing or your account? We're happy to help.</p>
<div class="contact-grid">
  <div class="cc"><i class="ti ti-mail"></i><h3>Email</h3><a href="mailto:support@scalewin.ai">support@scalewin.ai</a></div>
  <div class="cc"><i class="ti ti-phone"></i><h3>Phone</h3><p>[your support phone number]</p></div>
  <div class="cc"><i class="ti ti-map-pin"></i><h3>Address</h3><p>[your registered business address, India]</p></div>
</div>
<p style="text-align:center;font-size:14px;color:var(--ink-faint)"><strong>Business name:</strong> Giftyard (operating as ScaleWin) · <strong>GSTIN:</strong> [your GSTIN] · Support hours: Mon–Sat, 10am–7pm IST</p>

<div class="cform">
  <div class="field"><label>Your name</label><input id="cName" type="text" placeholder="Your name"></div>
  <div class="field"><label>Email</label><input id="cEmail" type="email" placeholder="you@yourstore.com"></div>
  <div class="field"><label>Message</label><textarea id="cMsg" rows="4" placeholder="How can we help?"></textarea></div>
  <div style="text-align:center"><button onclick="sendContact()">Send message</button></div>
</div>
</main>
