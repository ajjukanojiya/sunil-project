...
<div class="wrap"><header class="legal-head"><h1>Cookie Policy</h1><div class="upd">Last updated: 16 June 2026</div></header></div>
<main class="legal">
<p>This Cookie Policy explains how ScaleWin uses cookies and similar technologies on <a href="https://scalewin.ai">scalewin.ai</a>. It should be read together with our <a href="/privacy">Privacy Policy</a>.</p>

<h2>1. What are cookies?</h2>
<p>Cookies are small text files placed on your device when you visit a website. They help the site work, remember your preferences, and understand how it is used.</p>

<h2>2. Types of cookies we use</h2>
<ul>
<li><strong>Essential cookies</strong> — required for the website and your logged-in session to function (for example, authentication and security). These cannot be switched off.</li>
<li><strong>Preference cookies</strong> — remember your settings and choices for a better experience.</li>
<li><strong>Analytics cookies</strong> — help us understand how visitors use the site so we can improve it. These may be set by trusted third-party analytics providers.</li>
</ul>

<h2>3. Third-party cookies</h2>
<p>Some cookies may be set by third parties we use, such as analytics providers and our payment partner (Razorpay) during checkout. Their use of cookies is governed by their own policies.</p>

<h2>4. Managing cookies</h2>
<p>You can control or delete cookies through your browser settings. Please note that disabling essential cookies may affect how the website and your account function.</p>
...
<h2>6. Contact</h2>
<p>Questions about cookies? Email <a href="mailto:support@scalewin.ai">support@scalewin.ai</a>.</p>
</main>
