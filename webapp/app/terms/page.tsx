...
<div class="wrap"><header class="legal-head"><h1>Terms &amp; Conditions</h1><div class="upd">Last updated: 16 June 2026</div></header></div>
<main class="legal">
<p><strong>ScaleWin</strong> ("ScaleWin", "we", "us" or "our") is a software service operated by <strong>Giftyard</strong> ([legal entity / proprietor name], GSTIN: [your GSTIN]), with its registered office at [your registered business address, India]. These Terms &amp; Conditions ("Terms") govern your access to and use of the ScaleWin website and Service. By creating an account or using the Service, you agree to these Terms.</p>

<h2>1. The Service</h2>
<p>ScaleWin is a software platform that helps businesses create, manage and optimise digital advertising (such as Meta Ads and Google Ads) and related marketing activities, with the assistance of automation and AI.</p>

<h2>2. Eligibility</h2>
<p>You must be at least 18 years old and have the authority to enter into these Terms on behalf of yourself or the business you represent.</p>

<h2>3. Your account</h2>
<p>You are responsible for the information you provide, for maintaining the confidentiality of your login credentials, and for all activity under your account. Notify us immediately of any unauthorised use.</p>

<h2>4. Subscriptions, billing &amp; renewals</h2>
<ul>
<li>The Service is offered on a <strong>subscription basis</strong>. Plan fees and inclusions are shown on our pricing page.</li>
<li>Subscriptions are billed in advance and, unless cancelled, <strong>renew automatically</strong> for the same period through our payment partner, Razorpay.</li>
<li>You authorise us (via Razorpay) to charge your selected payment method for each billing cycle until you cancel.</li>
<li>Taxes (such as GST) may apply and will be charged as required by law.</li>
</ul>

<h2>5. Connected accounts &amp; ad spend</h2>
<p>To use the Service you may authorise us to access your advertising and store accounts. <strong>Your advertising spend is paid by you directly to the advertising platforms (e.g. Meta, Google) and is separate from your ScaleWin subscription fee.</strong> You are responsible for your own ad budgets and platform compliance.</p>

<h2>6. No guarantee of results</h2>
<p>We work hard to improve your marketing performance, but advertising outcomes depend on many factors outside our control. <strong>ScaleWin does not guarantee any specific results, revenue, ROAS or profit.</strong></p>

<h2>7. Acceptable use</h2>
<p>You agree not to misuse the Service, including: violating any law or platform policy; infringing others' rights; uploading harmful or unlawful content; attempting to disrupt, reverse-engineer or gain unauthorised access to the Service.</p>

<h2>8. Intellectual property</h2>
<p>The Service, including its software, design and content, is owned by us and our licensors. You retain ownership of your own business data and campaign content.</p>

<h2>9. Third-party services</h2>
<p>The Service integrates with third-party platforms (such as Meta, Google and Razorpay). Your use of those platforms is also subject to their respective terms and policies.</p>

<h2>10. Termination</h2>
<p>You may cancel at any time as described in our <a href="/refund">Refund &amp; Cancellation Policy</a>. We may suspend or terminate access if you breach these Terms or for legal or security reasons.</p>

<h2>11. Limitation of liability</h2>
<p>To the maximum extent permitted by law, ScaleWin and Giftyard shall not be liable for any indirect, incidental or consequential damages, or for lost profits, revenue or data. Our total liability for any claim shall not exceed the subscription fees you paid to us in the three (3) months preceding the claim.</p>

<h2>12. Indemnity</h2>
<p>You agree to indemnify and hold us harmless from claims arising out of your use of the Service, your content, or your breach of these Terms or any platform policy.</p>
...
<h2>15. Contact</h2>
<p>Questions about these Terms? Email <a href="mailto:support@scalewin.ai">support@scalewin.ai</a> or visit our <a href="/contact">Contact page</a>.</p>
</main>
